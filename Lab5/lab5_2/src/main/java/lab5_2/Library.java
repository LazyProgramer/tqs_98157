...
public class Library {
    ...
    public List<Book> findBooksDate(final Date from, final Date to) {
    ...
    public List<Book> findBooksAuthor(final String author) {
    ...
    public List<Book> findBooksTitle(final String title) {
        return store.stream().filter(book -> {
